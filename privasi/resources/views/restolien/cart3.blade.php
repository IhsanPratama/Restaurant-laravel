    ...
    <div class=" text-center" style="margin-top:20px;">
            <h1><i class="fa fa-shopping-bag"></i> Orderan Kamu</h1>
                        ...
                        <table class="table table-bordered">
                            <thead>
                                <tr class="cart-product">
                                    <th class="cart-product-item">Produk</th>
                                    <th class="cart-product-price">Harga</th>
                                    <th class="cart-product-quantity">Jumlah</th>
                                    <th class="cart-product-quantity">Catatan</th>
            ...
            <form action="{{url('/order/finish')}}" method="POST">
                ...
                <div class="col-xs-12 col-sm-12  col-md-12">
                        <div class="cart-total-amount">
                            ...
                            <h6>Meja Kamu : {{Auth::user()->name}}</h6>
                        ...
                        <input type="hidden" value="{{ Auth::user()->id }}" name="id_meja">
                            ...
                            <ul class="list-unstyled" style="margin-bottom:50px;margin-top:50px;">
                                    <li>Jumlah Order :<span class="pull-right text-right cart-product-price"><h5>Rp. {{ number_format($total,0) }}</h5></span></li> <br>
                                        <li><span class="pull-right text-right"><button type="submit" class="btn btn-default btn-element">Order</button></span></li>
                                        <li><span class="pull-right text-right"><a class="btn btn-default btn-element" href="{{url('/list-menu')}}">Kembali</a></span></li>
