...
<li>
    <a href="{{url('/guide')}}" data-toggle="" class=" menu-item">Petunjuk</a>
</li>
<li>
    <a href="{{url('/about')}}" data-toggle="" class=" menu-item">Tentang</a>
</li>
			...
			<ul>
				...
				<li data-transition="slideremovedown"
					...
					<div class="tp-caption" 
						...
						data-splitout="none" 
						data-responsive_offset="on">
						<div class="slide--subheadline">Buka</div>
					</div>
					...
					<div class="tp-caption" 
						...
						data-splitout="none" 
						data-responsive_offset="on">
						<div class="slide--headline">Jam 7 pagi  - 8 malam</div>
					</div>
					...
					<div class="tp-caption" 
						...
						<div class="slide--subheadline">
							Kami siap melayani anda setiap hari</div>
				...
				<li data-transition="slideoverhorizontal"
					...
					<div class="tp-caption" 
						...
						data-splitout="none" 
						data-responsive_offset="on">
						<div class="slide--subheadline">Dibuat dengan Kesungguhan</div>
					</div>
					...
					<div class="tp-caption" 
						...
						data-splitout="none" 
						data-responsive_offset="on">
						<div class="slide--headline">Makanan khas yang lezzatt</div>
					</div>
					...
					<div class="tp-caption" 
						...
						data-splitout="none" 
						data-responsive_offset="on">
						<div class="slide--bio text-center">&copy; Dengan Cita Rasa Yang Melegenda</div>
					</div>
        ...
        <div class="row">
            <div class="col-xs-12 col-sm-12 col-md-6 col-md-offset-3">
                <div class="heading heading-1 text--center mb-40">
                    <p class="heading--subtitle">Hello Pelanggan</p>
                    <h2 class="heading--title">Selamat Datang di &copy;Bale Dahar</h2>
        ...
        <div class="row clearfix">
            <div class="col-xs-12 col-sm-12 col-md-8 col-md-offset-2">
                <div class="heading heading-3 text--center">
                    <p class="heading--subtitle">Rasa Yang Enak Dari TerEnak</p>
                    <h2 class="heading--title mb-0 text-white">Temukan Menu Kami</h2>
                </div>
            </div>
            <!-- .col-md-8 end -->
        </div>
