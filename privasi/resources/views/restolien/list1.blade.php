...
<head>
    ...
    <!-- Document Title
    ============================================= -->
    <title>Rumah Makan Bale dahar</title>
</head>
...
<body>
            ...
            <div class="row">
                <div class="col-xs-12 col-sm-12 col-md-12">
                    ...
                    <ul class="nav nav-tabs">
                        <li class="active"><a href="#lunch" data-toggle="tab">Makanan</a></li>
                        <li><a href="#drinks" data-toggle="tab">Minuman</a></li>
                    </ul>
                    <!-- Tab panes -->
    ...
    <div class="footer--copyright text-center">
        ...
        <div class="container">
            <div class="row">
                <div class="col-xs-12 col-sm-12 col-md-12">
                    <span>&copy; 2019, With <i class="fa fa-heart"></i> by IhsanP, Dewiws , Haekal , Zulfia</span>
                </div>
            </div>
        </div>
        <!-- .container end -->
