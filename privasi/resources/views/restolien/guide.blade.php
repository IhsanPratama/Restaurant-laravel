...
<li class=" active">
    <a href="#" data-toggle="" class=" menu-item">Petunjuk</a>
</li>
<li>
			...
			<ul>
				...
				<li data-transition="fadefromtop"
					...
					<div class="tp-caption" 
						...
						<div class="slide--subheadline">Selamat datang</div>
					</div>
					...
					<div class="tp-caption" 
						...
						<div class="slide--headline">
                            Panduan Untuk Pelanggan Baru</div>
					</div>
                    ...
                    <div class="accordion accordion-1" id="">
                        ...
                        <div class="panel">
                            <div class="panel--heading">
                                <a class="" >1. Mintalah pelayan untuk masuk ke akun meja Anda</a>
                            </div>
                        </div>
                    </div>
                    <div class="accordion accordion-1" id="">
                        ...
                        <div class="panel">
                            <div class="panel--heading">
                                <a class="" >2. Pilih menu yang ingin Anda pesan</a>
                            </div>
                        </div>
                    </div>
                    <div class="accordion accordion-1" id="">
                        ...
                        <div class="panel">
                            <div class="panel--heading">
                                <a class="" >3. Lihat keranjang Anda, lalu klik "Pesan"</a>
                            </div>
                        </div>
                        <div class="accordion accordion-1" id="">
                            <!-- Panel 01 -->
                            <div class="panel">
                                <div class="panel--heading">
                                    <a class="" >4. Anda juga dapat membatalkan pesanan Anda dengan mengklik "Kembali"</a>
                                </div>
                            </div>
                    <!-- End .Accordion-->
                </div>
