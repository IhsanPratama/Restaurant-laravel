...
<section class="page-404 text-center bg-overlay bg-overlay-gradient">
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-xs-12 col-sm-12 col-md-6 col-md-offset-3">
                <div class="clearfix"></div>
                <p class="mb-30 text-white">Pembelian anda :</p>
                <ul>
                ...
                <a class="btn btn--bordered btn--primary" href="{{url('/list-menu')}}">beli lagi </a>
            </div>
        </div>
        <!-- .row end -->
    </div>
      ...
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          <div class="modal-header" >
            <h2 class="modal-title text-center" id="addModalLabel">Testimoni Anda</h2>
