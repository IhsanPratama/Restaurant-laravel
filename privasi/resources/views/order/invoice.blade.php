    ...
    <div class="col-md-4" style=" padding:20px;">
        <div class="panel panel-cryptic">
            <div class="panel-heading padding_30">
                ...
                <h3 class="text-center no-margin"><strong>Resi</strong></h3>
            </div>
                    ...
                    <table class="input-table table">
                        <thead>
                            <tr>
                                ...
                                <td class="text-bold text-right"><strong>Harga</strong></td>
                                <td class="text-right text-bold"><strong>Jumlah</strong></td>
                            ...
                            <tr>
                                ...
                                <td class="emptyrow"></td>
                                <td class="emptyrow text-right"><strong>Tanggal</strong></td>
