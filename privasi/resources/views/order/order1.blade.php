...
<li ><a href="{{url('/list-menu')}}"><i class="fa fa-shopping-cart"></i> <span>Tambah Orderan</span></a> </li>
              ...
              <div class="col-xs-12 col-sm-6 col-lg-4">
                  <div class="panel panel-default element-box-shadow buy-bitcoin">
                    ...
                    <div class="panel-body btc-table padding_30 overflow-table">
                      ...
                      <button type="submit" class="btn btn-default btn-element">Selesai</button>
