    ...
    <div class="container" style="color:white;">
            <div class="row">
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-6 col-md-offset-3" style="font-size:20px;">
                        ...
                        <a class="btn btn--bordered btn--primary" href="#" type="button" data-toggle="modal" data-target="#testiModal">Testimoni</a> 
                        @endif
                        <a class="btn btn--bordered btn--primary" href="{{url('/list-menu')}}">kembali </a>
                    </div>
                </div>
        <!-- .row end -->
    </div>
          ...
          <div class="modal-dialog" role="document">
            <div class="modal-content">
              <div class="modal-header" >
                <h2 class="modal-title text-center" id="addModalLabel" style="font-size:30px;">Testimoni anda</h2>
              ...
              <div class="modal-body" style="padding:20px;">
                <form action="{{url('/testi/store')}}" method="post">
                  {{ csrf_field() }}
                  <input name="nama" type="text" class="form-control" placeholder="Tuliskan nama anda" required>
                  <textarea name="testi" type="text" class="form-control" placeholder="Tuliskan testimoni anda" required></textarea>
    
              </div>
              <div class="modal-footer">
                <button type="submit" class="btn btn--bordered btn--primary">Simpan</button>
              </div>
            </form>
