...
@section('menu')  
  ...
  <li><a href="{{url('/transaction')}}" ><i class="fa fa-dollar"></i> <span>Transaksi</span></a>
  </li>
  
    <li><a href="{{url('/reports')}}" ><i class="fa fa-file"></i> <span>Laporan</span></a>
    </li>
    
    <li class="active"><a href="#" ><i class="fa fa-star"></i> <span>Testimoni</span></a>
    </li>
@endsection 
...
<div id="dashboard-v1" class="right_col" role="main">
            ...
            <div class="panel panel-default element-box-shadow">
              <div class="panel-heading padding_30">
                <h3 class="no-margin"><i class="fa fa-star"></i> Testimoni</h3> <br>
                       ...
                       <thead>
                         <tr>
                           <th class="text-center">No</i></th>
                            ...
                            <th class="text-center">Testimoni</i></th>
