...
<li >                           
  ...
  <li><a href="{{url('/list-menu')}}" ><i class="fa fa-shopping-cart"></i> <span>Tambah Order</span></a>
  </li>

  <li><a href="{{url('/order')}}" ><i class="fa fa-shopping-bag"></i> <span>Order</span></a>
  </li>
  
  <li><a><i class="fa fa-dollar"></i> <span>Transaksi </span><span class="fa fa-angle-down"></span></a>
    <ul class="nav child_menu">
...
<li ><a href="{{url('/list-menu')}}"><i class="fa fa-shopping-cart"></i> <span>Tambah Order</span></a> </li>
<li  ><a href="{{url('/order')}}"><i class="fa fa-shopping-bag"></i> <span>Order</span></a></li>
<li class="active"><a href="#"><i class="fa fa-dollar"></i> <span>Histori</span></a>
          ...
          <div id="dashboard-v1" class="right_col" role="main">
            ...
            <div class="panel panel-default element-box-shadow">
              <div class="panel-heading padding_30">
                <h3 class="no-margin"> <i class="fa fa-list"></i> Histori</h3> <br>
                      ...
                      <tr>
                          ...
                          <td>  
                              @if (Auth::user()->level =="3")
                                ...
                                @if (Auth::user()->level != "2")                                    
                                <a href="{{ url('/order/invoice/' . $order->id) }}" class="btn btn-sm btn-success">Cetak invoice</a>
                                @endif
                                @else 
