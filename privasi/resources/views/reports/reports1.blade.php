...
<li ><a href="#" type="button" data-toggle="modal" data-target="#addModal"><i class="fa fa-table"></i> <span>Tambah Meja</span></a> </li>
...
<li ><a href="{{url('/history')}}"><i class="fa fa-dollar"></i> <span>Histori</span></a>
...
<li class="active"><a href="#"><i class="fa fa-file"></i> <span>Laporan</span></a>
</li> 
@endif
@endsection 
          ...
          <div id="dashboard-v1" class="right_col" role="main">
            ...
            <div class="panel panel-default element-box-shadow">
              <div class="panel-heading padding_30">
                <h3 class="no-margin"> <i class="fa fa-file"></i> Laporan</h3> <br>
