...
@section('menu')  
  ...
  <li class="active"><a><i class="fa fa-home"></i> <span>Menu </span><span class="fa fa-angle-down"></span></a>
    <ul class="nav child_menu">
      <li><a href="#"><span>Makanan & Minuman </span></a></li>
            ...
            <div class="modal-dialog" role="document">
              <div class="modal-content">
                <div class="modal-header" style="background-color:#ffe139;">
                  <h2 class="modal-title text-center" id="addModalLabel"><i class="fa fa-plus"></i>Tambah Menu</h2>
                ...
                <div class="modal-body">
                  <form action="{{url('/menu/store')}}" method="post" enctype="multipart/form-data">
                    {{ csrf_field() }}
                    <input name="nama" type="text" class="form-control" placeholder="Nama Menu"> <br>
        ...
        <table id="trade-history" class="table table-stripped table-hover dataTable no-footer" data-page-length="10">
          <thead>
             <tr>
                    ...
                    <th class="text-center">Harga </i></th>
                    <th class="text-center">Kategori </i></th>
                    <th class="text-center">Status </i></th>
                    <th class="text-center" style="width:100px;">Opsi lain</th>
             </tr>
          </thead>
           <tbody>
